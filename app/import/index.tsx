...
const styles = StyleSheet.create({
  ...
  appName: { fontSize: 17, fontWeight: '600', color: '#1a1a1a' },
  appInstructions: { fontSize: 14, color: '#555', lineHeight: 20 },
  pickButton: {
  ...
  unitChipText: { fontSize: 16, fontWeight: '600', color: '#333' },
  unitChipTextActive: { color: '#fff' },
  unitHint: { fontSize: 13, color: '#888', paddingHorizontal: 4 },
  continueButton: {
    backgroundColor: '#007AFF',
    borderRadius: 12,
    paddingVertical: 15,
