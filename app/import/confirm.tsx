...
const styles = StyleSheet.create({
  ...
  summaryKey: { fontSize: 15, color: '#8E8E93' },
  ...
  mappingCsv: { flex: 1, fontSize: 13, color: '#8E8E93' },
  mappingArrow: { fontSize: 13, color: '#636366' },
  ...
  noteText: { fontSize: 13, color: '#FFD60A', lineHeight: 18 },
  importButton: {
  ...
  doneTitle: { fontSize: 26, fontWeight: '700', color: '#FFFFFF' },
  doneStats: { alignItems: 'center', gap: 4 },
  doneStat: { fontSize: 16, color: '#8E8E93' },
  doneNumber: { fontWeight: '700', color: '#007AFF' },
  doneSkipped: { fontSize: 14, color: '#636366' },
  doneButton: {
    backgroundColor: '#007AFF',
    borderRadius: 12,
    paddingVertical: 14,
